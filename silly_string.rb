...
favorite_word_in_all_caps = your_favorite_word.upcase # Put a . after your_favorite word and use a String
method.
...
bigger_word = "wow mom #{big_word}"# Use String concatenation to add "wow" and "mom" to big_word
